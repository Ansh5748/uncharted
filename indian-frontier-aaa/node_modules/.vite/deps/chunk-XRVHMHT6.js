  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
      ...
      await Promise.all([
        ...
        import("./shadowMap.vertex-WN4YFSIL.js"),
      ...
      await Promise.all([
        ...
        import("./shadowMap.vertex-R2IRV4SX.js"),
...
var DepthRenderer = class _DepthRenderer {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
      this._shaderLanguage = 1;
      await Promise.all([import("./depth.vertex-3HTKEMBN.js"), import("./depth.fragment-CCK5JDXU.js")]);
    } else {
...
//# sourceMappingURL=chunk-XRVHMHT6.js.map

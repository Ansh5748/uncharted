...
} from "./chunk-U4IRKJVH.js";
import {
  RGBDTextureTools
} from "./chunk-XZRBSGNA.js";
import {
  BoundingInfo,
  Camera,
  EffectFallbacks,
      ...
      let effect = scene.getEngine().createEffect(shaderName, {
        ...
        extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
          if (this._shaderLanguage === 1) {
            await Promise.all([import("./default.vertex-BXBX4BMK.js"), import("./default.fragment-TPR4LNM5.js")]);
          } else {
            await Promise.all([import("./default.vertex-MFZNEA3D.js"), import("./default.fragment-H43CL4EW.js")]);
          }
    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-FNSX767T.js"), import("./pbr.fragment-FREGGUGU.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-Y23US2CV.js"), import("./pbr.fragment-FVLJXY5G.js")]);
        }
        this._shadersLoaded = true;
      }
    }, engine);
...
//# sourceMappingURL=chunk-54MQYY74.js.map
